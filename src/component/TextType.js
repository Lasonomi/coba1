...
// Komponen ini mengetik, menghapus, dan mengulang teks tanpa mengubah navbar.
function TextType({
  text,
  as: Component = 'div',
  typingSpeed = 50,
  ...
  }, [currentCharIndex, displayedText, getRandomSpeed, isDeleting, isVisible, loop, onSentenceComplete, pauseDuration, reverseMode, textArray, currentTextIndex, deletingSpeed]);
